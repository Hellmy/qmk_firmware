...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    PB_1     ,S(KC_LCTL), S(KC_INS),KC_PSCR  , LT(3,KC_BTN1)  , KC_SPC , LT(3,KC_BTN3),        LT(3,KC_BTN1)  , LT(3,KC_BTN2)    , _______  ,S(KC_RGUI), _______  , S(KC_MINS), S(KC_EQL)
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    KC_LSFT   , AS_TOGG  , AS_DOWN  , AS_UP  , AS_RPT     ,S(KC_MINS), KC_ESC  ,             KC_ESC , KC_PGDN  , KC_MUTE  , TG(2)  , _______  , RALT(KC_S) , KC_RSFT     ,
